...
|---|---|---|---|
| Client CLI | `courier` | `internal/version.Client` | v0.11.0 |
| Relay server | `courier-relay` | `internal/version.Relay` | v0.9.0 |
| Web dashboard | `courier-dashboard` | `internal/version.Dashboard` | v0.13.0 |
